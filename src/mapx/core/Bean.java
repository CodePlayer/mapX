...
public class Bean extends LinkedHashMap<String, Object> {
	 ...
	 * @param keys 指定的key数组
	 * @return
	 * @see mapx.util.StringUtil#isEmpty(String)
	 * @see mapx.util.EasyDate#smartParse(String)
	 */
	 ...
	 * @return
	 * @see mapx.core.Bean#decode(Object, Object...)
	 */
	...
	*/
	 ...
	 * @param key 指定的参数名
	 * @return
	 * @see mapx.util.EasyDate#valueOf(Object)
	 */
	 ...
	 * @return
	 * @see mapx.util.EasyDate#parse(String, String)
	 */
	 ...
	 * @param keys 指定的key数组
	 * @return
	 * @see mapx.util.NumberUtil#isInt(Object)
	 */
	 ...
	 * @param keys 指定的key数组
	 * @return
	 * @see mapx.util.NumberUtil#isDouble(Object)
	 */
